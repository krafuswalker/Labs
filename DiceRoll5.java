...
public class DiceRoll5 {
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in); // Create a scanner to get users
												// answers
		String yesOrNo = "y"; // Declare a string variable to handle user yes no
								// answers
		do // Start a do loop to process inputs and print roll results
		{
			System.out.println("How many sides should each die have?");
			int sidesNum = sc.nextInt(); // Declare and assign value to the
											// number to process up to
			System.out.println("Number of sides is " + sidesNum);
			System.out.println("OK.  Enter 1 to Roll The Dice"); // Ask for and
																	// get while
																	// condition
			...
			System.out.println("Do You Want to Roll Again?"); // Ask for and get
																// while
																// condition
			yesOrNo = sc.next();
